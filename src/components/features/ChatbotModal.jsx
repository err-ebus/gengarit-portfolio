    ...
    <AnimatePresence>
      {open && (
        <motion.div 
          ...
          className="fixed bottom-24 right-6 z-50 w-[calc(100%-3rem)] max-w-sm bg-zinc-950/95 backdrop-blur-xl rounded-2xl shadow-[0_0_40px_rgba(0,0,0,0.5)] border border-zinc-800 flex flex-col overflow-hidden font-mono"
        >
          {/* Header */}
          ...
          {/* Messages */}
          <div className="flex-1 overflow-y-auto px-4 py-4 space-y-4 bg-zinc-950/50 scrollbar-thin scrollbar-thumb-zinc-800" style={{ maxHeight: '400px', minHeight: '300px' }}>
            {messages.length === 0 && (
