...
export const SectionHUD = ({ activeSection }) => {
  ...
  return (
    <div className="fixed left-8 bottom-8 z-40 hidden md:flex flex-col gap-4 items-center">
      {/* Vertical Track */}
      <div className="w-px h-24 bg-zinc-900 relative">
        <motion.div 
          initial={false}
      ...
      {/* Active Section Name */}
      <div className="absolute left-6 bottom-0 origin-bottom-left -rotate-90 whitespace-nowrap">
        <AnimatePresence mode="wait">
          <motion.span 
            key={activeSection}
            ...
            exit={{ opacity: 0, x: 10 }}
            className="text-[8px] font-black font-mono text-zinc-600 uppercase tracking-[0.5em] italic"
          >
